...
Faveurs = {
    ...
    "Arès" : "Augmentation des dégâts infligés, chaque attaque vous soigne de quelques points de vies",
    ...
    "Déméter" : "Les effets bénéfique des plantes curatives sont augmenté de 100%",
...
Benedictions ={
    ...
    "Arès" : "Le premier coup fatal subit d'une journée redonne tous vos points de vie",
    "Poséidon" : "Chacunes de vos attaques (qui touche ou non) crée une vague qui dans la direction de votre attaque, en ligne droite, sur 3 cases. \n Une personne touché par vos vagues perd une partie de sa vue pendant 1 tour (-2 roll des attaques) et devient vulnérable à des attaques critiques pendant 1 tour (19 devient un critique).",
...
Coleres = {
    ...
    "Arès" : "Chaque coup raté peut vous faire tomber vos armes",
    ...
    "Déméter" : "Les effets bénéfique des plantes curatives sont réduit de 50%",
    "Dionysos" : "Vous ne pouvez recevoir aucun bonus de rhapsode. S'il n'y a aucun rhapsode dans votre groupe, chaque musique que vous entendez vous est tellement insupportable que vous ne pouvez y rester a proximité, si c'est le cas, vous serez à genoux à vous boucher les oreilles.",
    "Hermès" : "Le prix des objets augmente de 15%. Votre vitesse de déplacement est réduite de 2 cases.",
    "Apollon" : "Les soins qui vous sont procurés ne marchent pas le jour, vous ne pouvez être soigné à la lumière du soleil (à l'ombre ne suffit pas)",
...
Maledictions = {
    ...
    "Arès" : "Vous avez une chance (50%) de rater une attaque qui aurait dû être un coup fatal. Si c'est le cas, l'ennemi peut contre attaquer.",
    ...
    "Déméter" : "Toutes plantes que tiens le joueur meurent sur le coup. Impossibilité de se soigner avec des herbes curatives.",
    "Dionysos" : "Vous avez les symptômes de l'ivresse sans boire, couplé à une gueule de bois. Chaque lancé de dés ne peut dépasser 15.",
    ...
    "Apollon" : "Les moyennes et fortes lumières sont insupportables pour ses yeux le forçant a être \"aveugle\" la journée",
    "Héphaïstos" : "Toute surface de métal est brûlante au toucher. Il est impossible de porter une armure"
}